import { profile, skillBars } from "../data/resume";
    ...
    <section className="bg-grey-50" id="about">
      <div className="container flex flex-col items-center py-16 md:py-20 lg:flex-row">
        ...
        <div className="w-full pl-0 pt-10 sm:w-3/4 lg:w-2/5 lg:pl-12 lg:pt-0">
          {skillBars.map((s, i) => (
            <div key={s.name} className={i === 0 ? "" : "pt-6"}>
              <div className="flex items-end justify-between">
                <h4 className="font-body font-semibold uppercase text-black">{s.name}</h4>
                <p className="font-body text-3xl font-bold text-primary">{s.percent}%</p>
              </div>
              <div className="mt-2 h-3 w-full rounded-full bg-lila">
                <div
                  className="h-3 rounded-full bg-primary transition-[width] duration-700"
